    ...
    render() {
        ...
        return (
            <div className="container-fluid">
                ...
                <div>
                    <Griddle results={this.props.eopDaily} tableClassName={'table table-bordered table-hover'} useGriddleStyles={false} showFilter={true} columnMetadata={ julianMetadata } useFixedHeader={true} settingsToggleClassName='btn btn-default' showSettings={true} useCustomPagerComponent={true} customPagerComponent={CustomPager} resultsPerPage={12}/>
                </div>
